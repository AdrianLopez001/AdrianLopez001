# Olá, eu sou o Adrian Lopes! 👋

Desenvolvedor de Software focado na construção de sistemas robustos, escaláveis e integrados com Inteligência Artificial. Atualmente cursando **Análise e Desenvolvimento de Sistemas (ADS)**, busco alinhar rigor técnico de Engenharia de Software com soluções de valor para o negócio.

---

### 💻 Minhas Especialidades & Foco Técnico

Tenho experiência no ecossistema **full-stack** e em **engenharia de dados/integrações**, com destaque para:
* **Backend de Alta Performance:** Desenvolvimento de APIs RESTful estruturadas, arquitetura baseada em microsserviços, persistência relacional e mensageria assíncrona.
* **Inteligência Artificial e Dados:** Pipelines de preparação de dados, treinamento de modelos preditivos, explicabilidade de modelos (SHAP) e arquiteturas de busca semântica corporativa (RAG).
* **Frontend Moderno:** Criação de dashboards corporativos responsivos, focando em performance, micro-interações fluidas e boas práticas de UX.
...
* **Conceito Chave:** Transparência algorítmica para o usuário final, com o modelo detalhando o *porquê* de cada previsão.
...
* Desenvolvido em Java/Spring Boot com indexação e recuperação inteligente de documentos técnicos em banco de dados vetorial.
* Demonstra conhecimento em processamento de linguagem natural (NLP), embeddings de texto e arquiteturas modernas de LLMs integradas a dados privados de forma segura.
...
Plataforma moderna de gestão médica integrada que simplifica a ponte entre equipes clínicas e pacientes.
* Estruturada no ecossistema Spring Boot com arquitetura limpa, cobrindo agendamento de consultas, históricos clínicos e proteção de dados médicos confidenciais.
